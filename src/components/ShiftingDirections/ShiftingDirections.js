...
const ShiftingDirections = () => {
  ...
  useEffect(() => {
    ...
    createObserver(mobileCannon1, "activate", 0.6, true);
    createObserver(mobileCannon2, "activate", 0.6, true);
    createObserver(mobileCannon3, "activate", 0.6, true);
    createObserver(mobileCannon4, "activate", 0.6, true);
    createObserver(mobileCannon5, "activate", 0.6, true);
    createObserver(mobileCannon6, "activate", 0.6, true);

    createObserver(cannon1, "activate", 0.5, true);
  }, []);
  return (
    <div className="parent-container-shifting-directions">
      ...
      <div className="changing-paths-container-two">
        <div className="para7-overflow-container-1" ref={para7_overflow_container_1}>
          <p className="narrator-paragraph-text">The young man scratched his head.</p>
        </div>
        <div className="para7-overflow-container-2" ref={para7_overflow_container_2}>
          <p className="response-text-two response-paragraph">“How, oh how will I ever be able to live and work as I desire?”</p>
        </div>
        <div className="para7-overflow-container-3" ref={para7_overflow_container_3}>
          <p className="narrator-paragraph-text">And so it happened, that a dear friend of his had recently started working as an IT-recruiter.</p>
        </div>
